...
const SidebarMenu = () => {
  ...
  // Base menu for both roles with common items
  const commonMenuItems = (
    <>
      ...
      <MenuItem 
        ...
        title={isSalon ? "Agendamentos" : "Meus Agendamentos"} 
        path="/appointments"
      >
        {isSalon && (
          <>
  ...
  if (isSalon) {
    return (
      <div className="mt-2 space-y-2 overflow-y-auto max-h-[calc(100vh-4rem)]">
        {commonMenuItems}
        {salonOnlyItems}
      </div>
    );
